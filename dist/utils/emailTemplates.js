...
exports.emailTemplates = {
    ...
    caseStatusUpdate: (dentistName, caseNumber, newStatus, patientName) => ({
    ...
    caseSubmissionConfirmation: (dentistName, caseNumber, patientName) => ({
    ...
    invoiceNotification: (dentistName, invoiceNumber, amount, dueDate) => ({
    ...
    lowStockAlert: (itemName, currentQuantity, minQuantity) => ({
    ...
    shipmentUpdate: (recipientName, trackingNumber, status, estimatedDelivery) => ({
